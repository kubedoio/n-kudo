...
UNIT_SRC_URL_DEFAULT="https://raw.githubusercontent.com/n-kudo/n-kudo/main/deployments/systemd/nkudo-edge.service"
...
BASE_URL="${NKUDO_EDGE_BASE_URL:-https://github.com/n-kudo/n-kudo/releases/download/${VERSION}}"
...
echo "2) enroll: NKUDO_ENROLL_TOKEN=<token> /usr/local/bin/nkudo-edge enroll --control-plane \"$CONTROL_PLANE_URL\""
